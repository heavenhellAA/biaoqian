...
namespace AvxTaskProject.Utils
{
    public class FtpWeb
    {
        string ftpServerIP;
        ...
        public List<FileInfoEntity> GetFilesDetailLists()
        {
            var res = new List<FileInfoEntity>();
            ...
            try
            {
                ...
                while (line != null)
                {
                    var a = line[25..29].Trim();
                    Console.WriteLine(a);
                    res.Add(new FileInfoEntity
                    {
                        dateTime = DateTime.Parse(line[..17].Trim(), dtfi),
                        FileName = line[39..].Trim(),
                        FileSize = string.IsNullOrWhiteSpace(line[30..39]) ? 0 : Convert.ToInt32(line[30..39].Trim()),
                        IsDir = !string.IsNullOrWhiteSpace(line[25..29])
                    });
